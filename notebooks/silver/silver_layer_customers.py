...
df = spark.read.format("parquet")\
    .load("abfss://bronze@<storage-account-name>.dfs.core.windows.net/customers")
...
df.write.mode("append").format("delta").save("abfss://silver@<storage-account-name>.dfs.core.windows.net/customers")

# COMMAND ----------

# MAGIC %sql
# MAGIC create schema databricks_catalog.silver
...
# MAGIC using delta 
# MAGIC location 'abfss://silver@<storage-account-name>.dfs.core.windows.net/customers'
